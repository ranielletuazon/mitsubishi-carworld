...
function VehicleCardSkeleton() {
    return (
        <div className="flex flex-col bg-white border border-gray-200 animate-pulse">
            <div className="h-44 bg-gray-300 " />
            <div className="flex flex-col gap-3 px-5 py-4 border-t border-gray-300 rounded">
                <div className="h-4 w-3/4 bg-gray-300 rounded" />
                <div className="flex items-baseline gap-2 pt-1">
                    <div className="h-2.5 w-8 bg-gray-300 rounded" />
