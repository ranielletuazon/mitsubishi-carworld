...
export default function XforceExterior() {
            ...
            <main className="w-full max-w-full bg-white">
                ...
                <section className="w-full bg-black py-10 sm:py-12 text-center px-4">
                    <h1 className="text-2xl sm:text-3xl font-black text-white uppercase tracking-tight mb-2">
                        All-New XFORCE Exterior
                    </h1>
                    <p className="text-sm text-white/60 max-w-2xl mx-auto">
                        From city streets to more rugged adventures, the
                        XFORCE’s stunning exterior stands out in any setting.
                    </p>
                </section>
                ...
                <section className="w-full bg-white py-14 sm:py-20">
                    <div className="container mx-auto px-4 lg:px-12">
                        ...
                        <div className="relative border border-gray-200 min-h-[420px] sm:min-h-[520px] lg:min-h-[640px]">
                            ...
                            <iframe
                                src="https://tours.exsight360.com/mitsubishi/xforce/exterior/v2/index.html"
                ...
                <section className="bg-white pb-14">
                    <div className="grid grid-cols-1 lg:grid-cols-2">
                        ...
                        <div className="flex flex-col md:gap-10 gap-8 justify-center px-6 sm:px-10 lg:px-16 py-8 lg:py-0 lg:order-2">
                    ...
                    <div className="container mx-auto px-4 lg:px-6 grid grid-cols-1 sm:grid-cols-2 gap-8 sm:gap-10">
                        <div>
                            ...
                            <p className="text-sm text-gray-700 leading-relaxed">
                                The LED daytime running lights feature a
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-700 leading-relaxed">
                                Complementing the XFORCE’s overall look, LED
                                tail lights mirror the T-shaped design.
                            </p>
                        </div>
                    </div>
                </section>
                ...
                <section className="w-full bg-white pb-14 sm:pb-20">
                    <div className="container mx-auto px-4 lg:px-6 grid grid-cols-1 sm:grid-cols-2 gap-8 sm:gap-10">
                        <div>
                            ...
                            <p className="text-sm text-gray-700 leading-relaxed">
                                Effortless storage access is possible with the
                                XFORCE’s hands-free electric tailgate, activated
                                by a convenient kicking motion.
                            </p>
                        </div>
                ...
                <section className="w-full bg-white pb-14 sm:pb-20">
                    <div className="container mx-auto px-4 lg:px-6 grid grid-cols-1 sm:grid-cols-2 gap-8 sm:gap-10">
                        <div>
                            ...
                            <p className="text-sm text-gray-700 leading-relaxed">
                                Conveniently adjust and fold side mirrors with a
                                single touch.
                            </p>
                        </div>
